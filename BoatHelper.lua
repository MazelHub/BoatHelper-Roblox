-- // BoatHelper - Premium Menu Script with ESP, WalkSpeed, JumpPower, AutoFarm, Fly & Teleport
...
ButtonContainer.ScrollBarImageColor3 = Color3.fromRGB(60, 60, 60)
...
local function CreateDropdown(name, description, items, callback)
	...
	ScrollingList.ScrollBarImageColor3 = Color3.fromRGB(60, 60, 60)
...
print("Доступные функции: Test Toggle, Player ESP, WalkSpeed, JumpPower, AutoFarm, Fly Mode, Fly Speed, Teleport to Player, Destroy GUI")